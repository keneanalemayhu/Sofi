                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <select name="category_id" class="form-select mb-2">
                                            ...
                                            ?>
                                                    <option value="<?= $item['id']; ?>" <?= $data['category_id'] == $item['id'] ? 'selected' : '' ?>><?= $item['name']; ?>
                                                    </option>
                                            <?php
                                                }
                                            } else {
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="file" name="image" class="form-control mb-2" accept="image/png,image/gif,image/jpeg,image/jpg">
                                        <label class="mb-0">Current Image</label>
                                        <img src="../uploads/product_pics/<?= $data['image']; ?>" alt="Product Image" height="50px" width="50px">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
