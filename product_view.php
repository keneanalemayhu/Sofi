        ...
        <div class="bg-light py-4">
            <div class="container product_data mt-3">
                <div class="row">
                    <div class="col-md-4">
                        <div class="shadow">
                            <img src="uploads/product_pics/<?= $product['image']; ?>" alt="Product Image" class="w-100">
                        </div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h5>ETB: <span class="text-success fw-bold"><?= $product['selling_price'] ?></span></h5>
                            </div>
                            <div class="col-md-6">
                                <h5>ETB: <s class="text-danger"><?= $product['original_price'] ?></s></h5>
                            </div>
                        </div>
                        <div class="row mt-3">
